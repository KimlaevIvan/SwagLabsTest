...
public class AppTest {
    ...
    public void testMailRu() {
        try {
            ...
            String user_name_login = ParseUtils.Pars(regex_user, user_names);
            ...
            String password = ParseUtils.Pars(regex_password, users_password);
            ...
            for (int i = 1; i <= 6; i++) {
                ...
                prise = Float.parseFloat(ParseUtils.Pars(regex_price, priseTextPage));
                if (prise > max_price) {
                    max_price = prise;
                    index_max = i;
                }
